...
public enum RNFGuiTextures implements ScreenElement {
    ...
    POINT_LEFT("widgets", 18, 0, 18, 18, 54, 54),
    POINT_RIGHT("widgets", 36, 0, 18, 18, 54, 54),
    UP_FROM_RIGHT("widgets", 0, 18,18, 18, 54, 54),
    CONNECT("widgets", 18, 18,18, 18, 54, 54),
    DOWN_CONNECT("widgets", 18, 36,18, 18, 54, 54),
    UP_FROM_LEFT("widgets", 0, 36,18, 18, 54, 54),
    DOWN_TO_RIGHT("widgets", 36, 36,18, 18, 54, 54),
    DOWN_TO_LEFT("widgets", 36, 18,18, 18, 54, 54);
