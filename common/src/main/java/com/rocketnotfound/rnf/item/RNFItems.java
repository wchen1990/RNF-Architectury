...
public class RNFItems {
    ...
    public static final RegistrySupplier<Item> LUNA_BLOCK = ITEMS.register("luna_block", () -> new BlockItem(RNFBlocks.LUNA_BLOCK.get(), new Item.Settings().group(CREATIVE_TAB)));
