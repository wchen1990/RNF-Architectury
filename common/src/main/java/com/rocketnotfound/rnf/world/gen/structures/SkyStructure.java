...
/* Source: https://github.com/TelepathicGrunt/StructureTutorialMod/blob/1.18.2-Forge-Jigsaw/src/main/java/com/telepathicgrunt/structuretutorial/structures/SkyStructures.java */
public class SkyStructure extends StructureFeature<StructurePoolFeatureConfig> {
    public SkyStructure() {
        // Create the pieces layout of the structure and give it to the game
        super(StructurePoolFeatureConfig.CODEC, SkyStructure::createPiecesGenerator, PostPlacementProcessor.EMPTY);
    }
    ...
    private static boolean isFeatureChunk(StructureGeneratorFactory.Context<StructurePoolFeatureConfig> context) {
        ...
        return !context.comp_306().method_41053(StructureSetKeys.OCEAN_MONUMENTS, context.comp_308(), chunkpos.x, chunkpos.z, 10);
    }
    ...
    public static Optional<StructurePiecesGenerator<StructurePoolFeatureConfig>> createPiecesGenerator(StructureGeneratorFactory.Context<StructurePoolFeatureConfig> context) {
        ...
        BlockPos blockpos = context.comp_309().getCenterAtY(0);
        ...
        int topLandY = context.comp_306().getHeightOnGround(blockpos.getX(), blockpos.getZ(), Heightmap.Type.WORLD_SURFACE_WG, context.world());
        ...
        if(structurePiecesGenerator.isPresent()) {
            ...
            RNF.LOG.log(Level.DEBUG, "SkyStructure based structure at {}", blockpos);
        }
