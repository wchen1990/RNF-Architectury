...
public class RNFRecipes {
    ...
    public static final RegistrySupplier<RecipeType> RITUAL_TYPE = RECIPE_TYPES.register("ritual", RitualRecipe.RitualRecipeType::new);
    public static final RegistrySupplier<RecipeSerializer> RITUAL_SERIALIZER = RECIPE_SERIALIZERS.register("ritual_serializer", RitualRecipe.Serializer::new);
